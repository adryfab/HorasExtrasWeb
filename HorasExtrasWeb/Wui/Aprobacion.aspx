...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        ...
        <ajaxToolkit:TabContainer ID="tabHorasExtras" runat="server" ActiveTabIndex="0">
            ...
            <ajaxToolkit:TabPanel ID="tabAtrasos" runat="server" HeaderText="Atrasos">
                <ContentTemplate>
                    <div style="overflow:auto;">
                        <asp:GridView ID="gvAprobarAtrasos" runat="server" AutoGenerateColumns="False" 
                            onrowcommand="GridViewAprAtr_RowCommand"
                            onrowdatabound="GridViewAprAtr_RowDataBound" 
                            >
                            <HeaderStyle CssClass="w3-indigo" />
                            <AlternatingRowStyle CssClass="w3-light-grey" />
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Suplementarias" Visible="false">
                                    <ItemTemplate>
                                        <asp:Label ID="SUPLEMENTARIAS" runat="server" Text='<%#Bind("SUPLEMENTARIAS") %>' />
                                    </ItemTemplate>
                                    <ItemStyle HorizontalAlign="Center"/>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Extraordinarias" Visible ="false">
                                    <ItemTemplate>
                                        <asp:Label ID="EXTRAORDINARIAS" runat="server" Text='<%#Bind("EXTRAORDINARIAS") %>' />
                                    </ItemTemplate>
                                    <ItemStyle HorizontalAlign="Center"/>
                                ...
                                <asp:TemplateField HeaderText="Atrasos">
                                    <ItemTemplate>
                                        <asp:Label ID="Atrasos" runat="server" Text='<%#Bind("Atrasos") %>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>
                        <br>
                        <tr id="trMostrarAtrasos" runat="server" visible="False">
                            <td runat="server">
                                <div>
